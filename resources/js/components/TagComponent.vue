<template>
    <div class="medicine">
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card-box">
                    <h4 class="text-dark header-title m-t-0 m-b-30">Add Tag</h4>

                    <div class="form-horizontal" role="form">
                        <div class="form-group">
                            <label class="col-md-3 control-label">Name</label>
                            <div class="col-md-9">
                                <input type="text" v-model="name" class="form-control" placeholder="Tag Name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label"></label>
                            <div class="col-md-9 text-right">
                                <button type="button" @click="AddTag" class="btn btn-primary btn-rounded waves-effect waves-light">ADD</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    export default {
        ...
        methods:{
            ...
            getData(){
                axios.get('/admin/data/get/tag')
                    .then((response)=>{
                        // handle success
                        this.alltag=response.data.tag;
                    })
                    .catch(function (error) {
                        // handle error
                        console.log(error);
