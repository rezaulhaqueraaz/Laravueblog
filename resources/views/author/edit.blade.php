                        ...
                        <div class="card-box">
                            ...
                            <div class="form-group">
                                ...
                                <select name="position" id="inputState" class="form-control">
                                    ...
                                    <option @if($post->position==2){{'selected'}}@endif value="2" disabled>Slider Section</option>
                                    <option @if($post->position==3){{'selected'}}@endif value="3" disabled>Trending Section</option>
                                </select>
                            </div>
                            <div class="form-group">
