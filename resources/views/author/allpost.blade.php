                        ...
                        @foreach(Auth::user()->posts as $post)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('author.post.edit',$post->id)}}" ><span class="badge badge-primary"><i class="fa fa-edit"></i></span></a>
                                    <a href="{{route('frontend.single',$post->slug)}}"><span class="badge badge-success"><i class="fa fa-low-vision"></i></span></a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <a href="{{route('author.post.delete',$post->id)}}" class="btn btn-danger">Yes</a>
