...
class ProfileController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if (isset($image))
        {
            $imagename = 'storage/profile/author/'.uniqid().$user->id.'.'.$image->getClientOriginalExtension();
            //  check category dir is exists
            if (!File::exists("storage/profile/admin")) {
                File::makeDirectory("storage/profile/author",0777,true);
            }
            // delete old image
            ...
            $destinationPath = 'storage/profile/author';
